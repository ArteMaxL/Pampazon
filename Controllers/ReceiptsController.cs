...
namespace Pampazon.Controllers
{
    ...
    public class ReceiptsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Receipt>> Create(Receipt receipt)
        {
            ...
            var client = await _context.Clients.FindAsync(receipt.ClientId);
            if (client == null)
        ...
        {
            var receipt = await _context.Receipts.FindAsync(receiptNumber);
            if (receipt == null)
                return NotFound();
        ...
        public async Task<IActionResult> AssignLocation(string receiptNumber, string productId, [FromBody] StockLocation location)
        {
            ...
            var stockPosition = await _context.StockPositions
